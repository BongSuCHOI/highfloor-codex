...
Standalone read-only viewer for [Understand-Anything](https://github.com/Egonex-AI/Understand-Anything) knowledge graphs. Opens the full interactive dashboard for a graph already generated with `$cx-understand-codebase analyze` — no LLM or API key. Only Node.js (>= 18) is required.
