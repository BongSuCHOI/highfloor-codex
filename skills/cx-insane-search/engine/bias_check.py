...
Exit code 0 if clean, 1 if violations found.
    ...
    uv run --isolated python engine/bias_check.py
    uv run --isolated python engine/bias_check.py --strict
"""
...
EXPLICIT_ALLOW_FILES = {
    ...
    # Paths are relative to the skill root so renaming or relocating the skill
    # does not silently disable this sanctioned exemption.
    "engine/phase0.py",
}
