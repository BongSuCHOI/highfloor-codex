...
Examples:
    ...
    bash scripts/run.sh "https://example.com/" --json
    bash scripts/run.sh "https://example.com/" --device mobile --trace
...
def build_parser() -> argparse.ArgumentParser:
    p = argparse.ArgumentParser(prog="bash scripts/run.sh",
...
def main(argv: list[str] | None = None) -> int:
    ...
    if not result.ok and (result.untried_routes or result.must_invoke_browser_automation):
        print(
            "\n════════════════════════════════════════════════════════════════\n"
        ...
        if result.must_invoke_browser_automation:
